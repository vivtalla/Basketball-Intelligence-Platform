...
_DOMAINS: List[MethodologyDomain] = [
    ...
    MethodologyDomain(
        ...
        season_type_support=["Regular Season"],
        sample_gates=["Claim confidence depends on source evidence count and specificity."],
        confidence_rules=["Opponent specificity, recency, sample count, and linkage quality drive confidence."],
        reliability_policy="Future calibrated evidence model should replace token-only confidence rules.",
        explainability_policy="Ground each claim in top evidence features and replay/deep-link support when available.",
        known_limitations=["Some claims are proxy-derived.", "Contradiction detection is not yet complete."],
        validation_notes=["Add contradiction fixtures where evidence supports both a strength and a risk."],
        last_validation_date="2026-04-28",
