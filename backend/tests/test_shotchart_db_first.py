...
# Sprint 81: legacy `play_by_play` table retired. Three tests that exercised
# the legacy fallback (test_game_detail_reports_legacy_event_stream_when_only_legacy_rows_exist,
# test_shot_completeness_report_distinguishes_legacy_vs_missing_game_events,
# test_pbp_coverage_reports_legacy_when_only_legacy_rows_exist) were deleted
# alongside the legacy table — they test code paths that no longer exist.
