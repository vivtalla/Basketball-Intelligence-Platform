...
def upgrade():
    if not _has_table("player_contracts"):
        op.create_table(
            ...
            sa.Column("is_player_option", sa.Boolean(), server_default=sa.text("0")),
            sa.Column("is_team_option", sa.Boolean(), server_default=sa.text("0")),
            sa.Column("is_non_guaranteed", sa.Boolean(), server_default=sa.text("0")),
            sa.Column("no_trade_clause", sa.Boolean(), server_default=sa.text("0")),
    ...
    if not _has_table("draft_pick_assets"):
        op.create_table(
            ...
            sa.Column("is_swap", sa.Boolean(), server_default=sa.text("0")),
            sa.Column("is_conveyed", sa.Boolean(), server_default=sa.text("0")),
    ...
    if not _has_table("player_injury_history"):
        op.create_table(
            ...
            sa.Column("is_recurring", sa.Boolean(), server_default=sa.text("0")),
    ...
    if not _has_table("milestone_snapshots"):
        op.create_table(
            ...
            sa.Column("season", sa.String(length=10)),
            sa.Column("is_career_milestone", sa.Boolean(), server_default=sa.text("1")),
            sa.Column("computed_at", sa.DateTime(), server_default=sa.func.now()),
