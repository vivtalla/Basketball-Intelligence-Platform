...
- **Deferred:** B5 keep-list ISR refactor (`/player-stats`, `/standings`, `/playoffs` server-component conversion). **Why:** different domain. Closeout: `specs/sprint-96-closeout.md`.
