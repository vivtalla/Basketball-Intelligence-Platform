...
Last updated: 2026-03-30 by Codex (Sprint 17 kickoff reset)
...
### Claude
- Branch: `feature/sprint-17-{slug}` (create fresh from current `master`)
- Scope: TBD at sprint kickoff
- Status: Unassigned
- PR: —

### Codex
- Branch: `codex-sprint-17-{slug}` (create fresh from current `master`)
- Scope: TBD at sprint kickoff
- Status: Unassigned
- PR: —
...
Set this at Sprint 17 kickoff after work is assigned.
...
2026-03-30 (Codex): Sprint 16 closed. See `specs/sprint-16-closeout.md`. The remaining live follow-through is operational `2025-26` warehouse catch-up from the clean attached-worker path, not an unresolved Sprint 16 code bug.
