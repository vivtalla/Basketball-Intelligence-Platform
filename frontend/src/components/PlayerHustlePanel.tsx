...
import { usePlayerHustle } from "@/hooks/usePlayerStats";
import type { PlayerHustleStats } from "@/lib/types";
...
export default function PlayerHustlePanel({ playerId, season, isPlayoff = false }: Props) {
  const { data, isLoading, error } = usePlayerHustle(playerId, season, isPlayoff);
